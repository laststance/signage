                ...
                <div id="download" className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
                      <a
                        href="https://github.com/laststance/signage/releases/download/v1.4.1/signage-1.4.1-arm64.dmg"
                      ...
                      <a
                        href="https://github.com/laststance/signage/releases/download/v1.4.1/signage-1.4.1-x64.dmg"
