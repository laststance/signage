                ...
                <div id="download" className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
                      <a
                        href="https://github.com/laststance/signage/releases/download/v1.4.5/signage-1.4.5-arm64.dmg"
                      ...
                      <a
                        href="https://github.com/laststance/signage/releases/download/v1.4.5/signage-1.4.5-x64.dmg"
